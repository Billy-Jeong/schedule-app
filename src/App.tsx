...
function App() {
  ...
  const login = useGoogleLogin({
    ...
    scope: 'https://www.googleapis.com/auth/calendar' // 쓰기 권한 포함
  })
          ...
          <div className="flex items-center space-x-3">
            ...
            {user ? (
              <div className="flex items-center space-x-2 bg-blue-50 px-3 py-1.5 rounded-full border border-blue-100">
                ...
                <span className="text-[12px] font-bold text-blue-700 uppercase tracking-tighter font-sans">구글 계정 연결됨</span>
              </div>
            ) : (
              <button 
                onClick={() => login()}
